...
const experiences = [
  {
    ...
    description: 'Working on the Brawse browser extension, developing and maintaining front-end features.',
    highlights: [
      ...
      'Contributed to improving user experience through iterative feature development and bug fixes',
    ],
  ...
  },
  {
    ...
    description: 'Working on high-performance backend services for AI diagnostics platform.',
    highlights: [
      ...
      'Collaborated with team, conducted code reviews and pair programming',
